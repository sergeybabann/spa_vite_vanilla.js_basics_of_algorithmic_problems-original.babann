...
<div class="main">
    ...
    <h2 class="main__title-2">Учебный центр "Специалист"</h2>
        ...
        <li class="main__list-1-item">
            <a class="main__link-default" href="/basic_of_programming_and_databases/introduction">
            Введение
            </a>
        </li>
        ...
        <!----- 01 LESSON ----->
        <li class="main__list-1-item">
            <a class="main__link-default" href="/basic_of_programming_and_databases/01_lesson">
        ...
        <!----- 02 LESSON ----->
        <li class="main__list-1-item">
            <a class="main__link-default" href="/basic_of_programming_and_databases/02_lesson">
